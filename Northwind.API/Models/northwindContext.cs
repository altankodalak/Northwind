...
namespace Northwind.API.Models
{
    public partial class northwindContext : DbContext
    {
        ...
        public virtual DbSet<SatisRaporu> SatisRaporu { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SatisRaporu>(entity =>
            {
                ...
                entity.ToView("SatisRaporu");

                entity.Property(e => e.CalisanAd)
                    .IsRequired()
                    .HasColumnName("Calisan Ad")
                    .HasMaxLength(10);
                ...
                entity.Property(e => e.MüşteriŞirketAdı)
                    .IsRequired()
                    .HasColumnName("Müşteri Şirket Adı")
                    .HasMaxLength(40);
            });
